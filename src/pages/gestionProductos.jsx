  ...
  return (
    <div className="container mx-auto overflow-y-auto p-4">
      <div className="flex justify-between items-center my-4">
        ...
        <div>
          <button onClick={() => setIsModalOpen(true)} className="btn btn-primary bg-blue-500 text-white px-4 py-2 rounded">Crear Producto</button>
        </div>
      </div>
      <div className="space-y-4">
        {products.map(product => (
          <div key={product.id} className="p-4 border rounded flex justify-between items-center">
            ...
            <div>
              <button onClick={() => handleEditProduct(product.id)} className="btn btn-secondary bg-yellow-500 text-white px-4 py-2 rounded mr-2">Modificar</button>
              <button onClick={() => handleDeleteProduct(product.id)} className="btn btn-danger bg-red-500 text-white px-4 py-2 rounded">Eliminar</button>
            </div>
          </div>
        ))}
      </div>
